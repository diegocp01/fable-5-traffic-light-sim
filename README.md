...
![Traffic light simulation screenshot](assets/traffic-light-simulation.png)
...
1. Download [`index.html` directly](https://github.com/diegocp01/fable-5-traffic-light-sim/raw/main/index.html).
